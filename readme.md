...
- project also features advanced and modern responsive design patterns. such as using **min(), max() and clamp()** functions. which let's me create responsive font sizes, paddings, margins and images with ease.
